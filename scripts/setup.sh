...
# ║                        AUTO-GENERATED FILE                               ║
# ║                                                                           ║
# ║  Generated by: goobits-cli v1.1.4                     ║
# ║  Generated from:                                          ║
# ║                                                                           ║
...
readonly PACKAGE_NAME="goobits-matilda-voice"
readonly COMMAND_NAME="voice"
readonly DISPLAY_NAME="Matilda Voice - Text to Speech"
readonly DESCRIPTION="Multi-provider text-to-speech with voice cloning"
readonly PYPI_NAME="goobits-matilda-voice"
...
show_install_success_message() {
    echo
    echo "Matilda Voice has been installed successfully!
...
show_dev_success_message() {
    echo
    echo "Matilda Voice has been installed in development mode!
...
show_upgrade_success_message() {
    echo
    echo "Matilda Voice has been upgraded successfully!
...
show_uninstall_success_message() {
    echo
    echo "Matilda Voice has been uninstalled.
...
install_system_dependencies() {
    ...
    if command -v apt-get >/dev/null 2>&1; then
        ...
        if ! dpkg -l | grep -q "^ii.*sox" 2>/dev/null; then
